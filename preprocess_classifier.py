...
if __name__ == '__main__':
    ...
    sampler = sampling_algs.fps_pure
    sampler_args = []
    train_dataset = utils.apply_subsample_transform(train_dataset,sampler,nr_points,sampler_args,sampler_type="idx")
    test_dataset = utils.apply_subsample_transform(test_dataset,sampler,nr_points,sampler_args,sampler_type="idx")
